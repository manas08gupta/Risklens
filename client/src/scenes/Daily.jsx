...
function Daily() {
  ...
  const totalSalesColor = theme.palette.secondary.main;
  const totalUnitsColor = theme.palette.secondary[600];
  ...
  }, [data, startDate, endDate, totalSalesColor, totalUnitsColor]);
